...
<body class="sb-nav-fixed">
    <a href="../dashboard.php" class="btn btn-primary mt-3 mb-3"><i class="fas fa-arrow-left"></i> Go Back to Dashboard</a>
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <a class="navbar-brand ps-3" href="dashboard.php">Assignment Table</a>
        ...
        <h1 type="text-center">Assignment Dashboard</h1>
